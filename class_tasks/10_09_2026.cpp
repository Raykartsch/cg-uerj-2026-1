...
// const float r_color = 1.0;
// const float g_color = 1.0;
// const float b_color = 1.0;


const float r_color = 1.0;
const float g_color = 1.0;
const float b_color = 0.0;
// Função responsável pela especificação dos parâmetros de iluminação
void DefineIluminacao (void)
{
    GLfloat luzAmbiente[4]={0.2,0.2,0.2,1.0};
    GLfloat luzDifusa[4]={0.7,0.7,0.7,1.0}; // "cor"
    GLfloat luzEspecular[4]={r_color, g_color, b_color, 1.0};// "brilho"
...
void Inicializa(void)
{
    ...
    glClearColor(r_color, g_color, b_color, 1.0f);
...
void PosicionaObservador(void)
{
    ...
    DefineIluminacao(); // Define a iluminação do objeto
}
